...
namespace NewsMaker
{
    internal interface ISendpulse
    {
        ...
        /// <returns></returns>
        Dictionary<string, object> createCampaign(string senderName, string senderEmail, string subject, string body,
        ...
        /// <returns></returns>
        Dictionary<string, object> smtpListEmails(int limit, int offset, string fromDate, string toDate, string sender,
            string recipient);
        /// <summary>
        ...
        /// <returns></returns>
        Dictionary<string, object> createPushTask(Dictionary<string, object> taskinfo,
        ...
        Dictionary<string, object> sendSmsCampaign(int bookId, string body, int transliterate = 1, string sender = "",
            string date = "");
        /// <summary>
        ...
        /// <param name="sender">Sender.</param>
        /// <param name="date">Date.</param>
        Dictionary<string, object> sendSmsCampaignByPhones(string phones, string body, int transliterate = 1,
        ...
        /// <param name="phones">Phones.</param>
        Dictionary<string, object> getSmsCampaignCost(string body, string sender, int addressBookId = 0,
            string phones = "");
        /// <summary>
        ///     Delete sms campaign.
        /// </summary>
        ...
        Dictionary<string, object> sendViberCampaign(string recipients, int addressBookId, string message, int senderId,
            string additional, int messageLiveTime = 60, string sendDate = "now");
        /// <summary>
