...
partial class NewsMakerForm
{
    ...
    private void InitializeComponent()
    {
        ...
        this.aclMain = new LB.Libs.ActionList();
        this.actExitProgram = new LB.Libs.ActionGh();
        this.actBegin = new LB.Libs.ActionGh();
        this.actSendToMe = new LB.Libs.ActionGh();
        ...
        // lgReport
        //
        this.lgReport.CustomizationFormText = "????????";
    ...
    private LB.Libs.ActionGh actBegin;
    private LB.Libs.ActionGh actSendToMe;
    private LB.Libs.LayoutControlGh layoutControl;
    ...
    private LB.Libs.ActionGh actExitProgram;
}
