...
partial class MessagesSetting
{
    ...
    private void InitializeComponent()
    {
        ...
        this.dataLayout = new LB.Libs.LayoutControlGh();
        this.comboZSC_CASE = new DevExpress.XtraEditors.LookUpEdit();
        this.gridControl = new LB.Libs.GridGh();
        this.gridView = new LB.Libs.ViewGh();
...
"овии совпадения трёх факторов: статус в базе; статус на Мешке; Способ доставки";
    ...
    private LB.Libs.LayoutControlGh dataLayout;
    private LB.Libs.GridGh gridControl;
    private LB.Libs.ViewGh gridView;
