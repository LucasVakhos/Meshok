...
using LB.Libs;
using MessageHook = GH.Components.MessageHook;
namespace MehokBrowser.Controls
{
    ...
    public class ActionList : Component, IExtenderProvider, ISupportInitialize
    {
        ...
        {
            _initializing = false;
            // MessageHook.RegForQueue(this); // GH.Components.ActionList type mismatch
        ...
        {
            // MessageHook.UnRegQueue(this); // GH.Components.ActionList type mismatch
        }
