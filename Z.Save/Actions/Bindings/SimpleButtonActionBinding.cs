...
// ============================================================================
// SimpleButtonActionBinding
// ----------------------------------------------------------------------------
// Binding для DevExpress SimpleButton / BaseButton.
// ============================================================================
public sealed class SimpleButtonActionBinding : ActionBindingBase<BaseButton>
{
    private readonly ToolTip? _toolTip;
    public SimpleButtonActionBinding(ActionBase action, BaseButton target, ToolTip? toolTip) : base(action, target)
    {
        _toolTip = toolTip;
    ...
    protected override void ApplyAll()
    {
        ...
        if (TargetComponent is SimpleButton simpleButton)
        {
            simpleButton.Image = Action.Image;
        }
