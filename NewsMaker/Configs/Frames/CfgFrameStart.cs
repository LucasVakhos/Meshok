...
public class CfgFrameStart : CfgCoreFrameType<CfgProgram>
{
    ...
    private DevExpress.XtraLayout.LayoutControlItem Пароль;
    ...
    private void InitializeComponent()
    {
        ...
        this.Пароль = new DevExpress.XtraLayout.LayoutControlItem();
        ...
        ((System.ComponentModel.ISupportInitialize)(this.Пароль)).BeginInit();
        ...
        this.UseSSLCheckEdit.Properties.Caption = "Использовать";
        ...
        this.ItemForSecret.OptionsToolTip.ToolTip = "Secret key для подключения";
        ...
        this.ItemForSendLimit.OptionsToolTip.ToolTip = "Ограничение рассылки";
        ...
        this.UseCollapceCheckEdit.Properties.Caption = "Сворачивать в трей, если не исполняется и сразу после загрузки, а так же при мини" +
"мизации";
        ...
        this.UseCloseIfNotDayCheckEdit.Properties.Caption = "Выгружать, если не день запуска";
        ...
        this.programGroup.Text = "Программа";
        //
        // ItemForUseCollapce
        //
        ...
        this.ItemForUseCollapce.Text = "Запускать";
        ...
        this.ItemForRunDay.Text = "День запуска";
        ...
        this.ItemForRunTime.Text = "Время запуска";
        ...
        this.ItemForUseCloseIfNotDay.OptionsToolTip.ToolTip = "Закрывать если дата не наступила";
        this.ItemForUseCloseIfNotDay.Size = new System.Drawing.Size(571, 23);
        this.ItemForUseCloseIfNotDay.Text = "Закрывать";
        ...
        this.ItemForUser.Text = "Логин";
        this.ItemForUser.TextSize = new System.Drawing.Size(73, 13);
        //
        // Пароль
        //
        this.Пароль.Control = this.PassWrdTextEdit;
        this.Пароль.Location = new System.Drawing.Point(0, 48);
        this.Пароль.Name = "Пароль";
        this.Пароль.OptionsToolTip.ToolTip = "Пароль для подключения";
        this.Пароль.Size = new System.Drawing.Size(571, 24);
        this.Пароль.TextSize = new System.Drawing.Size(73, 13);
        //
        // Email
        //
        ...
        this.Email.OptionsToolTip.ToolTip = "Обратный адрес";
        ...
        this.Port.Name = "Port";
        this.Port.OptionsToolTip.ToolTip = "Порт";
        ...
        ((System.ComponentModel.ISupportInitialize)(this.Пароль)).EndInit();
